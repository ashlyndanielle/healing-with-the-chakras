...
class Sacral extends Component {
    render() {
        ...
        const closedList = ['jealousy','shyness','eating disorders','lack of motivation','lethargic','unbalanced emotions'];
        const openedList = ['clear emotions and feelings', 'creativity', 'spontaneity', 'sensuality and sexuality', 'trusting', 'satisfaction'];
